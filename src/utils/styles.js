 ...
 *   T.fb  = Hanken Grotesk     (UI text — labels, buttons, metadata, body)
...
const S = {
  ...
  sub: { fontFamily: T.fm, fontSize: 9.5, letterSpacing: 2.2, fontWeight: 500, color: T.t3, textTransform: 'uppercase', marginTop: 4 },
  ...
  label: { display: 'block', fontSize: 10, letterSpacing: 1.8, textTransform: 'uppercase', color: T.t3, marginBottom: 8, fontFamily: T.fm, fontWeight: 500 },
  ...
  resLabel: { fontSize: 9.5, letterSpacing: 1.8, textTransform: 'uppercase', fontWeight: 500, color: T.t3, fontFamily: T.fm },
  resGold: { fontSize: 14, fontWeight: 700, color: T.gold, fontFamily: T.fm },

  /* Draw (big readout in calc) */
  drawLabel: { display: 'block', fontSize: 9.5, letterSpacing: 2.2, textTransform: 'uppercase', fontWeight: 500, color: T.t3, fontFamily: T.fm, marginBottom: 4 },
  ...
  statL: { display: 'block', fontSize: 9, letterSpacing: 1.6, textTransform: 'uppercase', fontWeight: 500, color: T.t3, marginTop: 4, fontFamily: T.fm },
  ...
  /* Log feed */
  logDate: { fontSize: 9.5, fontWeight: 500, color: T.gold, fontFamily: T.fm, letterSpacing: 2.2, marginBottom: 8, textTransform: 'uppercase' },
  ...
  libStatL: { display: 'block', fontSize: 9, letterSpacing: 1.6, textTransform: 'uppercase', fontWeight: 500, color: T.t3, fontFamily: T.fm, marginBottom: 4 },
